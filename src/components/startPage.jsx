...
const StartPage = ()=>{
    ...
    return(
        <div className="mx-4 content is-size-6-5">
            ...
            <img src="/tg-bot/assets/startPage/wallet_found.png" alt="" />
            ...
            <img src="/tg-bot/assets/startPage/private_key_qr_code.png" alt="" />
            <p>
            ...
            <img src="/tg-bot/assets/startPage/okx_telegram.png" alt="" />
...
If you're from India, you can import your wallet all the time. They restricted India to trading only. Cryptocurrency transfers are still available. Or find the app to download OKX on the official website.
            ...
            <ul>
                <li>
                    ...
                    <div className="mt-5">
                        <img src="/tg-bot/assets/startPage/step1-1.webp" alt="" />
                        <p> 
                    ...
                    <p>Import Found Private Key</p>
                        ...
                        <img src="/tg-bot/assets/startPage/step1-2.webp" alt="" />
                        <p>
                    ...
                    <div className="mt-5">
                        <img src="/tg-bot/assets/startPage/step1-3.webp" alt="" />
                        <p>
                ...
                <li>
                    ...
                    <b>Step 2: </b>Select the tron network
                        ...
                        <img src="/tg-bot/assets/startPage/step2-1.jpeg" alt="" />
                        <p>
                ...
                <li className="mt-5">
                    ...
                    <img className="mt-3" src="/tg-bot/assets/startPage/step2-2.webp" alt="" />
                    <p>
                        <i>
